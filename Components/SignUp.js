...
navigation.navigate("Login")
  ...
  return (
    ...
    <View style={styles.inputs}>
      <TextInput style={styles.inputsFields} placeholder='Enter Name' value={name} on onChangeText={(value) => { setName(value) }} />
     ...
     <View style={{flex:0.30 ,alignItems:'center', marginTop:50}}>
